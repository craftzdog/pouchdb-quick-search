...
module.exports = function (opts) {
  ...
  Object.keys(mapReduce).forEach(function (key) {
    pouchModule[key] = mapReduce[key];
  });

  var utils = require('./pouch-utils');
  var lunr = opts.lunr || require('lunr');
  ...
  pouchModule.search = utils.toPromise(function (opts, callback) {
    var pouch = this;
    ...
    var index = opts.index || indexes[language];
  ...
  if (typeof window !== 'undefined' && window.PouchDB) {
    window.PouchDB.plugin(pouchModule);
  }
